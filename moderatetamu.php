...
<?php
	...
	if($_SESSION['status'] == "user"){
		...
		$query2 = mysqli_query($conn, "SELECT * FROM visitors WHERE status_visitor = 'yet'");
...
<head>
    ...
    <title>Lists of Pelaporan Tamu </title>
	<!-- BOOTSTRAP STYLES-->
				...
				<br><li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="moderatetamu.php">Lists of Requests Tamu</a>
                            </li>
							<li>
 ...
 <div class="row" >
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <center><b>Daftar Pelaporan Tamu</b></center>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover w3-centered">
                                    <thead>
                                        <tr>
											...
											<th>Nama Villagers</th>
											<th>Nama Tamu</th>
											<th>Nomor Kartu Penduduk</th>
											<th>Alamat Asal</th>
                                    ...
                                    <tbody>
											...
											while($result3 = mysqli_fetch_array($query3)){
												echo '<tr>
														...
														<td>'.$result3['name_visitor'].'</td>
														<td>'.$result3['no_ktp_visitor'].'</td>
														<td>'.$result3['address_visitor'].'</td>
														<td>
															<form name="approver" action="modul/approvetamu.php" method="POST">
																<input value='.$result3['id_visitor'].' type="hidden" name="verified">
																<button class="btn waves-effect waves-teal" type="submit">Approve</button>
															</form>
														</td>
														<td>
															<form name="disapprover" action="modul/disapprovetamu.php" method="POST">
																<input value='.$result3['id_visitor'].' type="hidden" name="disapproved">
									...
									?>
										<p class="w3-center">Tidak ada Pelaporan Tamu baru</p>
									<?php 
										} 
									?>
                            </div>
