      ...
      <form class="w3-container " name="uploader" action="modul/daftarproses.php" method="POST" enctype="multipart/form-data">
        <div class="w3-section">
		  ...
		  <label><b>Phone</b></label>
			<input class="w3-input w3-round w3-border" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Phone" name="telpuser" id="telpuser" required><br/>
